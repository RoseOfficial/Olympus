...
/// <summary>
/// Smoke test: Kratos (MNK) DamageModule pushes Bloodbath via RoleActionPushers
...
public class DamageModuleBloodbathTests
{
    ...
    public void CollectCandidates_HpBelowThreshold_PushesBloodbathAtPriority6()
    {
        ...
        Assert.Contains(scheduler.InspectOgcdQueue(),
            c => c.Behavior == KratosAbilities.Bloodbath && c.Priority == 6);
    }
    ...
    public void CollectCandidates_BloodbathDisabled_DoesNotPush()
    {
        ...
        Assert.DoesNotContain(scheduler.InspectOgcdQueue(), c => c.Behavior == KratosAbilities.Bloodbath);
    }
