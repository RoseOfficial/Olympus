...
/// <summary>
/// Tests for Hermes (NIN) DamageModule.TryPushFeint. Pushes Feint via the
...
public class DamageModuleFeintTests
{
    ...
    public void Feint_PushedAtPriority7_WhenLevel22AndReady()
    {
        ...
        Assert.Contains(ogcd, c => c.Behavior == HermesAbilities.Feint && c.Priority == 7);
    }
    ...
    public void Feint_NotPushed_WhenLevelBelow22()
    {
        ...
        var ogcd = scheduler.InspectOgcdQueue();
        Assert.DoesNotContain(ogcd, c => c.Behavior == HermesAbilities.Feint);
    }
    ...
    public void Feint_NotPushed_WhenIsActionReadyReturnsFalse()
    {
        ...
        var actionService = MockBuilders.CreateMockActionService();
        // Default: IsActionReady returns false for everything (not set up here)
    ...
    public void Feint_OnDispatched_BroadcastsCooldownToParty()
    {
        ...
        var candidate = Assert.Single(scheduler.InspectOgcdQueue(),
            c => c.Behavior == HermesAbilities.Feint);
