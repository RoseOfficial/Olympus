...
/// <summary>
/// Viper party helper with VPR-specific targeting logic.
/// Extends BasePartyHelper with Serpent's Ire considerations.
/// </summary>
public sealed class EchidnaPartyHelper : BasePartyHelper
{
    public EchidnaPartyHelper(IObjectTable objectTable, IPartyList partyList)
    ...
    /// <summary>
    /// Counts party members in range for Serpent's Ire.
    /// </summary>
    /// <param name="player">The player character.</param>
    /// <param name="range">Range to check (default 30y for Serpent's Ire).</param>
