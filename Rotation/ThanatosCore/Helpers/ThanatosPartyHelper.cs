...
/// <summary>
/// Reaper party helper with RPR-specific targeting logic.
/// Extends BasePartyHelper with Arcane Circle considerations.
/// </summary>
public sealed class ThanatosPartyHelper : BasePartyHelper
{
    public ThanatosPartyHelper(IObjectTable objectTable, IPartyList partyList)
    ...
    /// <summary>
    /// Counts party members in range for Arcane Circle.
    /// </summary>
    /// <param name="player">The player character.</param>
    /// <param name="range">Range to check (default 30y for Arcane Circle).</param>
