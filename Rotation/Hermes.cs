...
public sealed class Hermes : BaseMeleeDpsRotation<IHermesContext, IHermesModule>
{
    ...
    // No AllowPreCombatOgcdDispatch: NIN pre-pull Suiton dispatches natively via ActionManager, not the scheduler. Add this flag only when a real pre-combat scheduler oGCD is introduced.
