...
/// <summary>
/// Helper for party member queries in Bard rotation.
/// </summary>
public sealed class CalliopePartyHelper
{
    private readonly IObjectTable _objectTable;
    private readonly IPartyList _partyList;

    public CalliopePartyHelper(IObjectTable objectTable, IPartyList partyList)
    {
