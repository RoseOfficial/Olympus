...
public static class BLMActions
{
    ...
    /// <summary>
    /// Swiftcast - Make next spell instant (Lv.18)
    /// </summary>
    public static readonly ActionDefinition Swiftcast = new()
    {
        ...
        RecastTime = 60f,
        MpCost = 0,
        AppliedStatusId = StatusIds.Swiftcast,
        AppliedStatusDuration = 10f
    };

    /// <summary>
    /// Surecast - Knockback immunity (Lv.44)
    /// </summary>
    public static readonly ActionDefinition Surecast = new()
    {
        ...
        RecastTime = 120f,
        MpCost = 0,
        AppliedStatusId = StatusIds.Surecast,
        AppliedStatusDuration = 6f
    };

    /// <summary>
    /// Lucid Dreaming - MP regeneration (Lv.14)
    /// Not typically needed for BLM, but available as role action
    /// </summary>
    public static readonly ActionDefinition LucidDreaming = new()
    {
        ...
        RecastTime = 60f,
        MpCost = 0,
        AppliedStatusId = StatusIds.LucidDreaming,
        AppliedStatusDuration = 21f
    };

    /// <summary>
    /// Addle - Target magic damage reduction (Lv.8)
    /// </summary>
    public static readonly ActionDefinition Addle = new()
    {
        ...
        Range = 25f,
        MpCost = 0,
        AppliedStatusId = StatusIds.Addle,
        AppliedStatusDuration = 15f
    };

    /// <summary>
    /// Sleep - Put target to sleep (Lv.10)
    /// </summary>
    public static readonly ActionDefinition Sleep = new()
    {
        ...
        Range = 30f,
        MpCost = 800,
        AppliedStatusId = StatusIds.Sleep,
        AppliedStatusDuration = 30f
    };
