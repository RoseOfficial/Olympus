...
/// 7 progressive lessons from fundamentals to advanced execution.
/// </summary>
public static class BlmLessons
{
    public static readonly LessonDefinition Lesson1 = new()
    {
        LessonId = "blm.lesson_1",
        JobPrefix = "blm",
        Title = "Fire and Ice Fundamentals",
        LessonNumber = 1,
        Description = "Learn Black Mage's core element system: Astral Fire for damage, Umbral Ice for MP recovery, and the critical 30-second element timer.",
        Prerequisites = Array.Empty<string>(),
        ConceptsCovered = new[]
        {
            BlmConcepts.AstralFire,
            BlmConcepts.UmbralIce,
        ...
        KeyPoints = new[]
        {
            "Astral Fire: Boosts Fire spell damage but stops MP regen",
            "Umbral Ice: Rapid MP recovery, reduced Ice spell damage",
            "Element timer is 30 seconds - refreshed by element-aligned spells",
            "Enochian is active whenever you have an element - losing it loses DPS",
            "Fire III and Blizzard III swap between phases instantly at max stacks",
        },
        RelatedAbilities = new[] { "Fire", "Fire III", "Blizzard", "Blizzard III" },
        Tips = new[]
        {
            "Never let your element timer drop - always refresh before 0",
            "Watch the element gauge - it shows your remaining timer",
        },
    };
    ...
    public static readonly LessonDefinition Lesson2 = new()
    {
        ...
        LessonNumber = 2,
        Description = "Understand BLM's gauge resources: Umbral Hearts for Fire IV efficiency, Polyglot for Xenoglossy, and Astral Soul for Flare Star.",
        Prerequisites = new[] { "blm.lesson_1" },
        ConceptsCovered = new[]
        {
            BlmConcepts.UmbralHearts,
            BlmConcepts.PolyglotStacks,
            BlmConcepts.GaugeOvercapping,
            BlmConcepts.MpManagement,
        },
        KeyPoints = new[]
        {
            "Umbral Hearts (3 max): Generated by Blizzard IV, reduce Fire spell MP cost",
            "Polyglot: Generates every 30s of Enochian, max 2-3 stacks",
            "Polyglot overcapping is a major DPS loss - spend before gaining new stacks",
            "Enter Fire phase with full MP (10,000) for maximum Fire IV casts",
        },
        RelatedAbilities = new[] { "Blizzard IV", "Xenoglossy", "Foul", "Amplifier" },
        Tips = new[]
        {
            "Amplifier grants a Polyglot stack - use during burst or when about to cap",
            "Always check Polyglot before Ice phase ends to avoid waste",
        },
    };
    ...
    public static readonly LessonDefinition Lesson3 = new()
    {
        ...
        JobPrefix = "blm",
        Title = "Fire Phase Execution",
        LessonNumber = 3,
        Description = "Master the damage phase: Fire IV spam, Despair finisher, and building Astral Soul for Flare Star.",
        Prerequisites = new[] { "blm.lesson_2" },
        ConceptsCovered = new[]
        {
            BlmConcepts.FirePhase,
        ...
        KeyPoints = new[]
        {
            "Fire IV: Your main damage spell, doesn't refresh element timer",
            "Despair: MP dump finisher, use when MP is too low for Fire IV",
            "Fire IV builds Astral Soul stacks (6 needed for Flare Star)",
            "Flare Star: Massive damage, requires 6 Astral Soul stacks",
            "Typical Fire phase: Fire IV x6 → Despair → Flare Star",
        },
        RelatedAbilities = new[] { "Fire IV", "Despair", "Flare Star" },
        Tips = new[]
        {
            "Fire IV doesn't refresh timer - weave Fire/Paradox if timer is low",
            "Despair dumps all remaining MP - always cast before switching to Ice",
        },
    };
    ...
    public static readonly LessonDefinition Lesson4 = new()
    {
        ...
        JobPrefix = "blm",
        Title = "Ice Phase & Thunder",
        LessonNumber = 4,
        Description = "Master the recovery phase: Blizzard IV for Umbral Hearts, Thunder DoT management, and smooth transitions back to Fire.",
        Prerequisites = new[] { "blm.lesson_3" },
        ConceptsCovered = new[]
        {
            BlmConcepts.IcePhase,
            BlmConcepts.ThunderDot,
            BlmConcepts.ParadoxMechanic,
        },
        KeyPoints = new[]
        {
            "Blizzard IV: Grants 3 Umbral Hearts, cast once per Ice phase",
            "Thunder III/IV: Maintain DoT uptime, apply during Ice phase",
            "Paradox: Instant in Umbral Ice 3, refreshes element timer",
            "Ice phase is short - B4 → Thunder → Paradox/F3 → back to Fire",
        },
        RelatedAbilities = new[] { "Blizzard IV", "Thunder III", "Thunder IV", "Paradox" },
        Tips = new[]
        {
            "Thunder DoT should have nearly 100% uptime on boss",
            "Paradox in UI3 is instant - use it for timer refresh or movement",
        },
    };
    ...
    public static readonly LessonDefinition Lesson5 = new()
    {
        ...
        Title = "Proc Management",
        LessonNumber = 5,
        Description = "Master Firestarter and Thunderhead procs: when to use them, when to hold them, and avoiding proc waste.",
        Prerequisites = new[] { "blm.lesson_4" },
        ConceptsCovered = new[]
        {
            BlmConcepts.FirestarterProc,
            BlmConcepts.ThunderheadProc,
            BlmConcepts.ProcPriority,
        },
        KeyPoints = new[]
        {
            "Firestarter: 40% chance from Fire IV, grants instant Fire III",
            "Thunderhead: Grants instant Thunder III/IV, from Thunder casts",
            "Procs last 30 seconds - don't let them expire unused",
            "Use Firestarter for movement or to extend Fire phase",
            "Thunderhead is your primary Thunder application method",
        },
        RelatedAbilities = new[] { "Fire III (proc)", "Thunder III (proc)", "Thunder IV (proc)" },
        Tips = new[]
        {
            "Firestarter during movement > losing uptime",
            "Plan proc usage around upcoming mechanics",
        },
    };
    ...
    public static readonly LessonDefinition Lesson6 = new()
    {
        ...
        JobPrefix = "blm",
        Title = "Cooldown Optimization",
        LessonNumber = 6,
        Description = "Maximize damage with Ley Lines, Triplecast for movement, and Manafont for extended Fire phases.",
        Prerequisites = new[] { "blm.lesson_5" },
        ConceptsCovered = new[]
        {
        ...
        KeyPoints = new[]
        {
            "Ley Lines: 15% cast speed buff zone for 30s (90s CD)",
            "Triplecast: 3 instant casts (60s CD, 2 charges) - use for movement",
            "Manafont: Instantly restores MP + grants Astral Fire (100s CD)",
            "Use Manafont to extend Fire phase with extra Fire IVs",
        },
        RelatedAbilities = new[] { "Ley Lines", "Triplecast", "Manafont", "Swiftcast" },
        Tips = new[]
        {
            "Place Ley Lines where you can stay - don't waste them moving",
            "Save Triplecast charges for mechanics requiring movement",
        },
    };
    ...
    public static readonly LessonDefinition Lesson7 = new()
    {
        ...
        Title = "Advanced Tactics",
        LessonNumber = 7,
        Description = "Final lesson: movement optimization, Xenoglossy decision-making, and AoE rotation with Flare and Foul.",
        Prerequisites = new[] { "blm.lesson_6" },
        ConceptsCovered = new[]
        {
        ...
        KeyPoints = new[]
        {
            "Movement priority: Triplecast > Xenoglossy > Procs > Swiftcast",
            "Xenoglossy: Instant 880 potency, use Polyglot stacks for movement or burst",
            "AoE rotation: High Fire II spam in AF, Flare to finish, Foul in UI",
            "For 3+ targets, switch to AoE rotation for efficiency",
        },
        RelatedAbilities = new[] { "Xenoglossy", "Foul", "High Fire II", "High Blizzard II", "Flare" },
        Tips = new[]
        {
            "Pre-plan movement - know when you'll need instant casts",
            "Xenoglossy during party buffs > holding for movement that might not come",
        },
    };
...
/// <summary>
/// RDM (Circe) lesson content - 7 progressive lessons covering Red Mage fundamentals through advanced optimization.
/// </summary>
public static class RdmLessons
{
    public static readonly LessonDefinition Lesson1 = new()
    {
        LessonId = "rdm.lesson_1",
        JobPrefix = "rdm",
        Title = "Mana Foundation",
        LessonNumber = 1,
        Description = "Learn the fundamentals of Red Mage's dual mana system and how to maintain balance for optimal damage.",
        Prerequisites = Array.Empty<string>(),
        ConceptsCovered = new[]
        {
            RdmConcepts.BlackMana,
            RdmConcepts.WhiteMana,
            RdmConcepts.ManaBalance,
            RdmConcepts.ManaImbalance,
        },
        KeyPoints = new[]
        {
            "Black Mana: Generated by Verthunder III (+6), Verfire (+5), and dark magic",
            "White Mana: Generated by Veraero III (+6), Verstone (+5), and light magic",
            "Keep mana within 30 of each other for optimal finisher potency",
            "Imbalanced mana (>30 diff) reduces finisher damage significantly",
        },
        RelatedAbilities = new[] { "Jolt III", "Verthunder III", "Veraero III", "Verfire", "Verstone" },
        Tips = new[]
        {
            "Watch your mana gauge constantly - balance is key to RDM damage",
            "If one mana is high, prioritize casting the opposite element",
        },
    };
    ...
    public static readonly LessonDefinition Lesson2 = new()
    {
        ...
        JobPrefix = "rdm",
        Title = "Dualcast Mastery",
        LessonNumber = 2,
        Description = "Master the Dualcast system - Red Mage's signature mechanic that makes every other spell instant.",
        Prerequisites = new[] { "rdm.lesson_1" },
        ConceptsCovered = new[]
        {
        ...
        KeyPoints = new[]
        {
            "Dualcast: Any hardcast (2.5s+) grants Dualcast buff for 15s",
            "Dualcast makes your next spell instant - use for long casts like Verthunder/Veraero",
            "Standard pattern: Hardcast (Jolt/Verfire/Verstone) → Instant (Verthunder/Veraero)",
            "Swiftcast provides emergency instant when Dualcast isn't available",
        },
        RelatedAbilities = new[] { "Jolt III", "Verthunder III", "Veraero III", "Impact", "Swiftcast" },
        Tips = new[]
        {
            "Never let Dualcast expire - always have a long spell ready",
            "ABC: Always Be Casting - minimize GCD downtime",
        },
    };
    ...
    public static readonly LessonDefinition Lesson3 = new()
    {
        ...
        Title = "Proc Management",
        LessonNumber = 3,
        Description = "Understand how to manage Verfire Ready and Verstone Ready procs for optimal mana generation and DPS.",
        Prerequisites = new[] { "rdm.lesson_2" },
        ConceptsCovered = new[]
        {
            RdmConcepts.VerfireProc,
            RdmConcepts.VerstoneProc,
            RdmConcepts.ProcPriority,
            RdmConcepts.ProcFishing,
            RdmConcepts.Acceleration,
        },
        KeyPoints = new[]
        {
            "Verthunder III/Veraero III have ~50% chance to grant opposite proc",
            "Procs last 30s - use expiring procs (<5s) before they fall off",
            "When not expiring, use procs to balance mana (low side gets priority)",
            "Acceleration guarantees proc from next Verthunder/Veraero (2 charges, 55s CD)",
        },
        RelatedAbilities = new[] { "Verfire", "Verstone", "Acceleration" },
        Tips = new[]
        {
            "Track proc timers - losing a proc is a DPS loss",
            "Use Acceleration when you need a guaranteed proc or for burst windows",
        },
    };
    ...
    public static readonly LessonDefinition Lesson4 = new()
    {
        ...
        JobPrefix = "rdm",
        Title = "Melee Combo Fundamentals",
        LessonNumber = 4,
        Description = "Learn when to enter the melee combo and how to execute it properly without dropping combo or wasting mana.",
        Prerequisites = new[] { "rdm.lesson_3" },
        ConceptsCovered = new[]
        {
            RdmConcepts.MeleeEntry,
            RdmConcepts.ComboProgression,
            RdmConcepts.ComboTimer,
            RdmConcepts.ManaOvercap,
        },
        KeyPoints = new[]
        {
            "Enter melee combo at 50|50 mana minimum (both Black and White)",
            "Combo: Enchanted Riposte (20|20) → Zwerchhau (15|15) → Redoublement (15|15)",
            "Combo timer is 30s - complete the full sequence or lose progress",
            "Don't overcap mana (>90) - enter combo to spend before capping",
        },
        RelatedAbilities = new[] { "Enchanted Riposte", "Enchanted Zwerchhau", "Enchanted Redoublement" },
        Tips = new[]
        {
            "Plan your combo timing around mechanics - don't start if you'll be forced off boss",
            "Melee combo hits are instant - great for movement phases",
        },
    };
    ...
    public static readonly LessonDefinition Lesson5 = new()
    {
        ...
        JobPrefix = "rdm",
        Title = "Finisher System",
        LessonNumber = 5,
        Description = "Master the finisher sequence after melee combo - Verflare/Verholy, Scorch, Resolution, and Grand Impact.",
        Prerequisites = new[] { "rdm.lesson_4" },
        ConceptsCovered = new[]
        {
        ...
        KeyPoints = new[]
        {
            "After Redoublement: Use Verflare (if Black ≤ White) or Verholy (if White < Black)",
            "Chosen finisher guarantees opposite proc (Verflare → Verfire Ready)",
            "Scorch follows Verflare/Verholy (Lv.80), Resolution follows Scorch (Lv.90)",
            "Grand Impact (Lv.96) follows Resolution - completes the finisher chain",
        },
        RelatedAbilities = new[] { "Verflare", "Verholy", "Scorch", "Resolution", "Grand Impact" },
        Tips = new[]
        {
            "Finisher selection auto-corrects mana imbalance - pick the lower side",
            "All finishers are instant - use for movement if needed",
        },
    };
    ...
    public static readonly LessonDefinition Lesson6 = new()
    {
        ...
        Title = "Burst Windows",
        LessonNumber = 6,
        Description = "Optimize your burst with Embolden timing, Manafication usage, and oGCD weaving for maximum damage.",
        Prerequisites = new[] { "rdm.lesson_5" },
        ConceptsCovered = new[]
        {
        ...
        KeyPoints = new[]
        {
            "Embolden: 5% party magic damage for 20s (120s CD) - align with party buffs",
            "Manafication: Doubles mana (cap 50|50), enables immediate melee combo",
            "Enter melee combo during burst windows for maximum damage output",
            "Fleche (25s), Contre Sixte (35s) - use on cooldown, weave between GCDs",
        },
        RelatedAbilities = new[] { "Embolden", "Manafication", "Fleche", "Contre Sixte", "Vice of Thorns", "Prefulgence" },
        Tips = new[]
        {
            "Hold Manafication briefly if party buffs are coming in ~5s",
            "Don't clip GCDs when weaving - one oGCD per GCD window is safe",
        },
    };
    ...
    public static readonly LessonDefinition Lesson7 = new()
    {
        ...
        Title = "Advanced Optimization",
        LessonNumber = 7,
        Description = "Final lesson: movement optimization, gap closers, AoE rotation, and putting it all together for high-level play.",
        Prerequisites = new[] { "rdm.lesson_6" },
        ConceptsCovered = new[]
        {
        ...
        KeyPoints = new[]
        {
            "Corps-a-corps: Gap closer (2 charges) - use to get into melee range",
            "Engagement/Displacement: Melee oGCDs - weave during combo",
            "AoE rotation at 3+ targets: Veraero II/Verthunder II, Impact, Enchanted Moulinet",
            "Movement priority: Dualcast instants > Procs > Swiftcast > melee combo",
        },
        RelatedAbilities = new[] { "Corps-a-corps", "Engagement", "Displacement", "Verthunder II", "Veraero II", "Enchanted Moulinet" },
        Tips = new[]
        {
            "Pre-plan Manafication timing for fight phases and downtime",
            "RDM has excellent mobility - use Dualcast and melee combo for movement",
        },
    };
...
/// <summary>
/// PCT (Iris) lesson content - 7 progressive lessons covering Pictomancer mechanics.
/// </summary>
public static class PctLessons
{
    public static readonly LessonDefinition Lesson1 = new()
    {
        ...
        LessonNumber = 1,
        Description = "Learn the core mechanics of Pictomancer: the Palette Gauge, White Paint stacks, and basic combo rotation.",
        Prerequisites = Array.Empty<string>(),
        ConceptsCovered = new[]
        {
            PctConcepts.PaletteGauge,
            PctConcepts.WhitePaint,
            PctConcepts.ComboBasics,
            PctConcepts.BlackPaint,
        },
        KeyPoints = new[]
        {
            "Palette Gauge: Builds to 100 from your base combo, enables Subtractive Palette",
            "White Paint: 5 stacks maximum, generated by combo finishers, spent on Holy in White",
            "Base combo: Fire in Red → Aero in Green → Water in Blue (generates gauge and paint)",
            "Black Paint: Proc from using Creature Muses, enables powerful Comet in Black",
        },
        RelatedAbilities = new[] { "Fire in Red", "Aero in Green", "Water in Blue", "Holy in White", "Comet in Black" },
        Tips = new[]
        {
            "Keep your combo flowing - the three-step pattern builds both gauge and paint",
            "Don't cap White Paint at 5 - use Holy in White to spend stacks",
        },
    };
    ...
    public static readonly LessonDefinition Lesson2 = new()
    {
        ...
        JobPrefix = "pct",
        Title = "Canvas Mastery",
        LessonNumber = 2,
        Description = "Master the three canvas types: Creature, Weapon, and Landscape motifs, and learn optimal pre-pull preparation.",
        Prerequisites = new[] { "pct.lesson_1" },
        ConceptsCovered = new[]
        {
            PctConcepts.CreatureMotifs,
            PctConcepts.WeaponCanvas,
            PctConcepts.LandscapeCanvas,
            PctConcepts.CanvasPrepull,
        },
        KeyPoints = new[]
        {
            "Creature Motifs: Pom, Wing, Claw, Maw - paint portraits to summon Living Muse",
            "Weapon Canvas: Hammer Stamp - paint to enable Striking Muse and hammer combo",
            "Landscape Canvas: Starry Sky/Star - paint for Starry Muse (2-min raid buff)",
            "Pre-pull: Paint all three canvases before combat for immediate burst access",
        },
        RelatedAbilities = new[] { "Pom Motif", "Wing Motif", "Claw Motif", "Maw Motif", "Hammer Motif", "Starry Sky Motif" },
        Tips = new[]
        {
            "Always have at least one canvas painted during combat for flexibility",
            "Painting takes time - use downtime phases to prepare canvases",
        },
    };
    ...
    public static readonly LessonDefinition Lesson3 = new()
    {
        ...
        JobPrefix = "pct",
        Title = "Muse Abilities",
        LessonNumber = 3,
        Description = "Learn to use the three Muse abilities: Living Muse (creatures), Striking Muse (hammer), and Starry Muse (landscape).",
        Prerequisites = new[] { "pct.lesson_2" },
        ConceptsCovered = new[]
        {
            PctConcepts.LivingMuse,
            PctConcepts.StrikingMuse,
            PctConcepts.StarryMuse,
            PctConcepts.MuseTiming,
        },
        KeyPoints = new[]
        {
            "Living Muse: Summons creature from canvas, grants Black Paint proc for Comet",
            "Striking Muse: Activates hammer combo (3 hits), high burst damage",
            "Starry Muse: 20s party buff (5% damage), your 2-minute burst window",
            "Muse timing: Use Living/Striking during Starry Muse window for maximum burst",
        },
        RelatedAbilities = new[] { "Living Muse", "Striking Muse", "Starry Muse", "Mog of the Ages", "Retribution of the Madeen" },
        Tips = new[]
        {
            "Starry Muse is a party buff - coordinate with other raid buffs",
            "Don't hold Muses too long - they have individual cooldowns to manage",
        },
    };
    ...
    public static readonly LessonDefinition Lesson4 = new()
    {
        ...
        LessonNumber = 4,
        Description = "Master the Subtractive Palette system: activating it at 50+ gauge and using the powerful Cyan/Magenta/Yellow spells.",
        Prerequisites = new[] { "pct.lesson_3" },
        ConceptsCovered = new[]
        {
            PctConcepts.SubtractivePalette,
            PctConcepts.SubtractiveCombo,
            PctConcepts.MonochromaticTones,
            PctConcepts.PaletteSpending,
        },
        KeyPoints = new[]
        {
            "Subtractive Palette: Activate at 50+ Palette Gauge, unlocks Cyan combo",
            "Subtractive combo: Thunder in Cyan → Stone in Yellow → Blizzard in Magenta",
            "Monochromatic Tones: Each Cyan hit builds gauge for Star Prism finisher",
            "Spend at 50: Don't overcap gauge - use Subtractive Palette when available",
        },
        RelatedAbilities = new[] { "Subtractive Palette", "Thunder in Cyan", "Stone in Yellow", "Blizzard in Magenta", "Star Prism" },
        Tips = new[]
        {
            "Always complete the full Cyan combo - interrupting loses DPS",
            "Star Prism is your big finisher - save it for burst windows when possible",
        },
    };
    ...
    public static readonly LessonDefinition Lesson5 = new()
    {
        ...
        JobPrefix = "pct",
        Title = "Paint Spenders",
        LessonNumber = 5,
        Description = "Optimize your paint spending with Holy in White, Comet in Black, and the powerful Rainbow Drip proc.",
        Prerequisites = new[] { "pct.lesson_4" },
        ConceptsCovered = new[]
        {
        ...
        KeyPoints = new[]
        {
            "Holy in White: Spends 1 White Paint, instant cast, use to prevent capping",
            "Comet in Black: Spends Black Paint proc, very high potency, top priority",
            "Rainbow Drip: Proc from certain abilities, instant high-potency spell",
            "Priority: Comet in Black > Rainbow Drip > Holy in White (for paint management)",
        },
        RelatedAbilities = new[] { "Holy in White", "Comet in Black", "Rainbow Drip" },
        Tips = new[]
        {
            "Comet in Black is your highest priority instant - never let the proc expire",
            "Rainbow Drip also has a timer - watch your buff bar",
        },
    };
    ...
    public static readonly LessonDefinition Lesson6 = new()
    {
        ...
        Title = "Burst Windows",
        LessonNumber = 6,
        Description = "Optimize your 2-minute burst with Starry Muse timing, hammer combos, and party coordination.",
        Prerequisites = new[] { "pct.lesson_5" },
        ConceptsCovered = new[]
        {
            PctConcepts.StarryMuseBurst,
            PctConcepts.HammerCombo,
            PctConcepts.PartyCoordination,
        },
        KeyPoints = new[]
        {
            "Starry Muse Burst: 2-minute window, align all Muses and high-damage abilities",
            "Hammer Combo: Hammer Stamp → Hammer Brush → Polishing Hammer (instant chain)",
            "Burst sequence: Starry Muse → Living Muse → Comet → Hammer combo → Star Prism",
            "Party coordination: Align Starry Muse with other raid buffs (Battle Litany, etc.)",
        },
        RelatedAbilities = new[] { "Starry Muse", "Hammer Stamp", "Hammer Brush", "Polishing Hammer", "Star Prism" },
        Tips = new[]
        {
            "Pre-paint all canvases before burst for maximum damage",
            "Hold abilities briefly if party buffs are coming in 5 seconds",
        },
    };
    ...
    public static readonly LessonDefinition Lesson7 = new()
    {
        ...
        Title = "Advanced Optimization",
        LessonNumber = 7,
        Description = "Final lesson: AoE rotation, movement optimization with instants, and putting everything together for high-level play.",
        Prerequisites = new[] { "pct.lesson_6" },
        ConceptsCovered = new[]
        {
        ...
        KeyPoints = new[]
        {
            "AoE at 3+ targets: Fire II in Red → Aero II in Green → Water II in Blue",
            "Movement: Use instant casts (Holy, Comet, Rainbow Drip, Hammer combo)",
            "Slidecast: Start moving near end of cast bar for minimal downtime",
            "Plan ahead: Know when mechanics require movement, save instants accordingly",
        },
        RelatedAbilities = new[] { "Fire II in Red", "Aero II in Green", "Water II in Blue", "Holy in White", "Hammer Stamp" },
        Tips = new[]
        {
            "PCT has excellent mobility through paint spenders and hammer combo",
            "Keep painting during downtime to prepare for uptime phases",
        },
    };
...
public static class LessonRegistry
{
    ...
    public static IReadOnlyList<LessonDefinition> GetLessonsForJob(string jobPrefix)
    {
        return jobPrefix.ToLowerInvariant() switch
        {
            ...
            "rdm" => RdmLessons.AllLessons,
            "pct" => PctLessons.AllLessons,
    ...
    public static IReadOnlyList<LessonDefinition> GetAllLessons()
    {
        return WhmLessons.AllLessons
            ...
            .Concat(RdmLessons.AllLessons)
            .Concat(PctLessons.AllLessons)
            .ToArray();
    }
}
